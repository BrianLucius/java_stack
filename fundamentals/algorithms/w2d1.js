 ...
 */
 class BSTNode {
  ...
  console.log("Is empty: ", emptyTree.isEmpty());

  console.log("Min: ",emptyTree.min());
  console.log("Max: ",emptyTree.max());
  console.log("Min Recursive: ",emptyTree.minRecursive());
  ...
  */
  ...
  console.log("Min Recursive: ",twoLevelTree.minRecursive());
  ...
  */
    ...
    console.log("Min Recursive: ",threeLevelTree.minRecursive());
