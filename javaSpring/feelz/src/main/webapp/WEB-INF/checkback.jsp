		...
		<div class="row d-flex justify-content-center">
			<div class="col-md-4 border bg-white rounded shadow p-3">
				<div class="text-center">
					<h4 class="alert-success rounded p-2 mb-4">You have submitted a Feelz within the last five minutes.</h4>
					<div class="mb-2"><h4>Your enthusiasm and support are appreciated!</h4></div>
					<div class="mb-4"><h4>Please come back later to submit another Feelz.</h4></div>
				</div>
				<div class="text-center">
					<div><h4>Share this <a href="http://feelz.cc" target="_blank">link</a> to my project with your friends, family, and associates.</h4></div>
				</div>
	<!-- 		<div class="mb-5">
					<h4>Trending emotions over the past 24 hours</h4>
				</div> -->
			</div>
		</div>
